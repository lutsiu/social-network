...
export default function SharePopupResponsive(props: Props) {
  ...
  return (
    <motion.ul
      ...
      className="shadow popup-tweet-share fixed
      bottom-0 bg-black w-full rounded-3xl text-zinc-100 z-20"
    >
      ...
      <li
        className="flex font-bold text-2xl gap-[1.3rem] items-center p-[1.2rem] popup-tweet-share-li-bookmark"
