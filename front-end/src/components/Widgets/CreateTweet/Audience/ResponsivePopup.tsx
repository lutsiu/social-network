...
export default function AudiencePopupResponsive(props: Props) {
  ...
  return (
    <motion.div className="audience-popup z-100 absolute shadow w-full h-fit rounded-2xl bottom-0 bg-black pt-[1.5rem]"
      initial={{opacity: 0}}
