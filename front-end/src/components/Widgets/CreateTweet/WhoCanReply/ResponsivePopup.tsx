...
export default function WhoCanReplyResponsivePopup(props: Props) {
  ...
  return (
    <motion.div
      className="who-can-reply-popup absolute bottom-0 bg-black shadow w-full h-fit rounded-3xl"
      initial={{ opacity: 0 }}
